...
<header>
    <nav>
        ...
        <?php if (estConnecte()): ?>
            ...
            <a href="pages/user/historique.php">Mon historique</a>
            <?php if (estAdmin()): ?>
                <a href="pages/admin/dashboard.php">Administration</a>
            <?php endif; ?>
...
<main class="hero">
    ...
    <?php if (estConnecte()): ?>
        <a href="pages/user/qcm.php" class="btn-primary">Lancer un QCM</a>
        <a href="pages/user/historique.php" class="btn-secondary">Mon historique</a>
    <?php else: ?>
